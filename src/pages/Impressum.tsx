    ...
    <div className="min-h-screen bg-cream text-charcoal font-sans selection:bg-g-yellow selection:text-charcoal overflow-x-hidden flex flex-col">
      ...
      <main className="flex-grow pt-48 pb-32 px-6 max-w-3xl mx-auto w-full">
        ...
        <div className="space-y-12 text-lg font-sans font-light text-charcoal/80 leading-relaxed">
          <section>
            <h2 className="text-2xl font-serif font-black text-charcoal mb-4">Angaben gemäß § 5 DDG</h2>
            <p>
              Daniel Lizardo<br />
              <span className="reverse-contact">31 .rtsregälhcsleO</span><br />
              <span className="reverse-contact">tragttutS 91607</span>
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-serif font-black text-charcoal mb-4">Kontakt</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-serif font-black text-charcoal mb-4">Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h2>
            <p>
              Daniel Lizardo<br />
              <span className="reverse-contact">31 .rtsregälhcsleO</span><br />
              <span className="reverse-contact">tragttutS 91607</span>
          ...
          <section>
            <h2 className="text-2xl font-serif font-black text-charcoal mb-4">EU-Streitschlichtung</h2>
            <p>
              Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit:{' '}
              <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" className="text-g-blue hover:text-g-red hover:underline break-all">
          ...
          <section>
            <h2 className="text-2xl font-serif font-black text-charcoal mb-4">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h2>
            <p>
